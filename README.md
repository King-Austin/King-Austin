...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&pause=1000&color=7AA2F7&center=true&vCenter=true&width=620&lines=Full-Stack+Software+Engineer;Builder+of+Scalable+Systems;Security+%7C+AI+%7C+Commerce+%7C+EdTech" alt="Typing SVG" />

# Nworah Ebuka Augustus

**Building production systems across Security, E-Commerce, EdTech, and AI**

[![Portfolio](https://img.shields.io/badge/Portfolio-nworahebuka.com.ng-7aa2f7?style=for-the-badge&logo=vercel&logoColor=white)](https://nworahebuka.com.ng)
...
> Zero-trust multi-factor attendance system built to eliminate proxy attendance in universities
...
### 🔹 [Storely](https://github.com/King-Austin/storely)
> Multi-vendor marketplace built for Nigeria's informal market — a direct Selar alternative
...
| | |
|---|---|
| **Stack** | `Django` `React` `TypeScript` `Paystack` `WhatsApp Cloud API` |
| **Features** | WhatsApp drug search bot, Paystack billing, CME system, inventory analytics, multi-pharmacy support |
| **Status** | 🔨 In Progress |
...
## 🌐 Open Source I Follow & Contribute To
